...
class PRCC(object):
    ...
    def __init__(self, root="data", verbose=True, **kwargs):
        ...
        val, num_val_pids, num_val_imgs, num_val_clothes, _ = self._process_dir_train(self.val_dir)

        query_same, query_diff, gallery, num_test_pids, num_query_imgs_same, num_query_imgs_diff, num_gallery_imgs, num_test_clothes, gallery_idx = (
