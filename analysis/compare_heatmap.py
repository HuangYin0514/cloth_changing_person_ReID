...
# -------------------------- 配置参数 --------------------------
# 请修改以下三个路径为你实际的文件夹路径
FOLDER1_PATH = "/Users/drhy/Desktop/vis/5/B/outputs/actmap/"  # 第一个图片文件夹
FOLDER2_PATH = "/Users/drhy/Desktop/vis/5/M/outputs/actmap/"  # 第二个图片文件夹
OUTPUT_FOLDER = "/Users/drhy/Desktop/vis/5/results/"  # 输出文件夹（当前目录下）
# -------------------------------------------------------------
