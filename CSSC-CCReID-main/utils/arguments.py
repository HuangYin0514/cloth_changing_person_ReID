...
def get_args():
    ...
    parser.add_argument("--height", type=int, default=384, help="height of an image")
    parser.add_argument("--width", type=int, default=192, help="width of an image")
    parser.add_argument("--horizontal_flip_pro", type=float, default=0.5, help="Random probability for image horizontal flip")
    parser.add_argument("--pad_size", type=int, default=10, help="Value of padding size")
    parser.add_argument("--random_erasing_pro", type=float, default=0.5, help="Random probability for image random erasing")
    ...
    parser.add_argument("--test_batch", default=128, type=int, help="test batch size")
    parser.add_argument("-j", "--num_workers", default=8, type=int, help="number of data loading workers")
    parser.add_argument("--num_instances", type=int, default=8, help="number of instances per identity")
    ...
    parser.add_argument("--warm_up_factor", default=0.1, type=float, help="warm up factor")
    parser.add_argument("--warm_up_method", default="linear", type=str, choices=["constant", "linear"], help="warm up factor")
    parser.add_argument("--warm_up_epochs", default=10, type=int, help="take how many epochs to warm up")
    parser.add_argument("--step_milestones", default=[30, 60], nargs="*", type=int, help="epoch milestones to decay learning rate, multi steps")
    parser.add_argument("--gamma", default=0.1, type=float, help="learning rate decay")
    parser.add_argument("--weight_decay", default=5e-04, type=float, help="lr weight decay")
    parser.add_argument("--weight_decay_bias", default=0.0005, type=float, help="lr weight decay for layers with bias")

    parser.add_argument("--resume", type=str, default="", metavar="PATH", help="pre-trained model path")
    ...
    parser.add_argument("--tri_start_epoch", type=int, default=35, help="the epoch of starting to use triplet loss")
